<div class="w3-container" style="margin-top:20px">
	<div class="w3-half">
		...
		<form action="<?php echo URL; ?>login" method="post">
			...
			<input class="w3-input" type="password" name="password" placeholder="<?php echo L::login_pwP;?>" required>
			<button type="submit" name="log_in_acc" class="w3-button w3-round w3-border w3-border-blue"><?php echo L::login_button;?></button>
			<div>
				<?php echo L::login_noAcc;?> <a href="<?php echo URL;?>signup"><?php echo L::login_noAccButton;?></a><br>
				<?php echo L::login_forgot;?> <a href="<?php echo URL;?>login/forgot"><?php echo L::login_forgotButton;?></a>
			</div>
		</form>
	</div>
