...
<div class="w3-container w3-col l6 m8">
	<!-- Email -->
	<h3>Account email</h3>
	<i class="w3-text-gray">your email here</i>
	...
	<form action="<?php echo URL; ?>account/update/3" method="post">
		...
		<input class="w3-input" type="text" name="address2">
		<label>Town/City</label>
		<input class="w3-input" type="text" name="city">
		<label>Postcode</label>
		<input class="w3-input" type="text" name="postcode">
		<label>Country</label>
		...
		<input class="w3-input" type="text" name="phone" placeholder="eg. +38641123456">
		<label>Date of birth</label> <i class="w3-opacity w3-small">Certain events might require you to be of a certain age.</i>
		<input class="w3-input" type="date" name="" placeholder="">
		...
		<label>Other</label>
		<input class="w3-radio" type="radio" name="gender" value="silent">
